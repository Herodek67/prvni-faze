...
namespace GeometryDashUltraSmooth
{
    public class GameForm : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (gameOver)
            {
                g.DrawString("ZEMÿEL JSI!", new Font("Arial", 36, FontStyle.Bold), Brushes.Red, 250, 150);
                g.DrawString("Stiskni 'R' pro restart", new Font("Arial", 16), Brushes.White, 320, 210);
            }
            else if (levelComplete)
            {
                g.DrawString("LEVEL DOKON»EN!", new Font("Arial", 36, FontStyle.Bold), Brushes.Lime, 200, 150);
                g.DrawString("Stiskni 'R' pro hr·nÌ znovu", new Font("Arial", 16), Brushes.White, 300, 210);
            }
            else
            {
